...
export const PRODUCT_VERSION = "3.5.6" as const;
...
export const REGISTRY_ENTITY_COUNT = 912 as const;
export const ENRICHMENT_VERSION = "2026-09-17-reselected-v4" as const;
