...
function bundle(): RuntimeBundle {
  ...
  return {
    release: { appId: "rikkyo-uk-vocab", productVersion: "3.5.1", engineVersion: "common-vocab-engine/1.0.0", datasetVersion: "test", persistenceSchemaVersion: 3, exportFormatVersion: 3, indexedDbVersion: 3, commonEngineCommit: "test", enrichmentVersion: "test" },
