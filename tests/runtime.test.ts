...
import { APP_ID, CORE_ENTITY_COUNT, REGISTRY_ENTITY_COUNT } from "../src/config";
...
function validBundle(): RuntimeBundle {
  ...
  return { manifest: { appId: APP_ID, dataVersion: "phase17-test-fixture", registryEntityCount: REGISTRY_ENTITY_COUNT, coreEntityCount: CORE_ENTITY_COUNT, generatedFromPhase: 17 }, registry, core };
}
