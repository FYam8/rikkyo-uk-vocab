const RELEASE = "3.4.0--common-vocab-engine-1.0.0--0.23.0-reselected--e2026-09-17-r1--p3";
...
async function buildAtomicCache() {
  ...
  if (release.productVersion !== "3.4.0" || release.engineVersion !== "common-vocab-engine/1.0.0" || release.datasetVersion !== data.dataVersion || release.persistenceSchemaVersion !== 3 || release.enrichmentVersion !== data.enrichmentVersion) {
