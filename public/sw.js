const RELEASE = "3.3.1--common-vocab-engine-1.0.0--0.22.1-core--e2026-09-17--p3";
...
async function buildAtomicCache() {
  ...
  if (release.productVersion !== "3.3.1" || release.engineVersion !== "common-vocab-engine/1.0.0" || release.datasetVersion !== data.dataVersion || release.persistenceSchemaVersion !== 3 || release.enrichmentVersion !== data.enrichmentVersion) {
