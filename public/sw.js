const RELEASE = "3.5.6--common-vocab-engine-1.0.0--0.24.0-lexical--e2026-09-17-r4--p3";
...
async function buildAtomicCache() {
  ...
  if (release.productVersion !== "3.5.6" || release.engineVersion !== "common-vocab-engine/1.0.0" || release.datasetVersion !== data.dataVersion || release.persistenceSchemaVersion !== 3 || release.enrichmentVersion !== data.enrichmentVersion) {
